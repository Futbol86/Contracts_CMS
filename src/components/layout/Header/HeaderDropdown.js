...
class HeaderDropdown extends Component {
    ...
    componentWillMount() {
        ...
        //     this.setState({
        //         userDetail: userData.username + "(" + userData.userGroupDetail && userData.userGroupDetail.group_code + ")",
        //     });
        // }
    }
    ...
    dropAccnt() {
        ...
        return (
            <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
                <DropdownToggle nav>
                    <img src={this.state.avatarImg} className="img-avatar" alt={this.state.email} /> <br />
                    <strong className="text-primary">{userData.username + " (" + (userData.userGroupDetail && userData.userGroupDetail.group_name) + ")"}</strong>
                </DropdownToggle>
                <DropdownMenu right>
