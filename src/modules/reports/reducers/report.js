import {
    ...
    DOC_EXPORT_ARCHIVE_BOOK_TO_EXCEL, DOC_EXPORT_SAMPLE_31_TO_EXCEL, CLEAR_EXCEL_EXPORT
} from '../actions';
...
const thongKeReducer = (state = defaultState, action = {}) => {
    switch (action.type) {
        ...
        case DOC_EXPORT_SAMPLE_31_TO_EXCEL.SUCCESS:
            console.log('--- DOC_EXPORT_SAMPLE_31_TO_EXCEL', action.payload.data.data)
            return {
                ...state,
                remoteExcel: action.payload.data.data || action.payload.data,
            };
