...
import {loadListNewDongAHopDong, setDisplayFullContext, DOC_exportNewContractListToEXCEL, clearExcelExport} from '../actions';
import {getNewDongAHopDongList, getNewDongAHopDongPaginationInfo, getNewDongAHopDongFilterInfo, getNewDongAHopDongFullContext, getRemoteEXCEL} from "../selectors";
...
import NewDongAHopDongListComponent from "../components/NewDongAHopDongList";
...
class HopDongList extends Component {
    componentDidMount() {
        ...
        this.props.loadListNewDongAHopDong(payload);
    ...
    render() {
        ...
        return (
            <NewDongAHopDongListComponent {...this.props} 
...
const mapStateToProps = (state) => ({
    ...
    contracts:           getNewDongAHopDongList(state),
    pagination:          getNewDongAHopDongPaginationInfo(state),
    userData:            getUserData(state),

    filterData:          getNewDongAHopDongFilterInfo(state),
    fullContext:         getNewDongAHopDongFullContext(state),
...
const mapDispatchToProps = (dispatch) => ({
    ...
    loadListNewDongAHopDong:  payload => dispatch(loadListNewDongAHopDong(payload)),
