...
import {FieldPrepend, FieldInputPure, FieldAutoComplete} from '../../../../components/common/Form';
import FieldDatePicker from '../../../../components/common/Form/FieldDatePicker';
import {NGAN_CHAN_FILTER_OPTIONS} from '../../constants';

class NganChanListFilter extends Component {
    render() {
        const {userGroups, hasSelectOption, handleSubmit, submitting, pristine, invalid} = this.props;
            ...
            <Form onSubmit={handleSubmit} className="form-inline">
                <FormGroup>
                    <InputGroup>
                        ...
                        {/* <Field name="prevention_type_id" type="hidden" component={FieldInputPure}
                        ...
                        >
                            {NGAN_CHAN_FILTER_OPTIONS && NGAN_CHAN_FILTER_OPTIONS.map((option, idx) => {
...
export default NganChanListFilter;