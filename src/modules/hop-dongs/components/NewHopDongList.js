...
import NewHopDongListItem from "./NewHopDong/NewHopDongListItem";
import Pagination from '../../../components/common/Pagination';
import ShowModalInfoModal from "../../dashboard/components/Dashboard/ShowMoreInfoModal";
import NewHopDongListFilter from '../containers/NewHopDong/NewHopDongListFilter';

const NewHopDongList = ({contracts, fullContext, userGroups, currentModalId, handleShowMoreClick, handleModalChange, pagination, onChangePage, handleExportExcelFile}) => (
                            ...
                            <tbody> 
                                {(contracts && contracts.length > 0)
                                    ? contracts.map((contract, idx) => (
                                        <NewHopDongListItem key={idx} contract={contract} handleShowMoreClick={handleShowMoreClick}/>
                                    ))
