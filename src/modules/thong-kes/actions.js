...
export const DOC_EXPORT_TNMT_LAND_DATA_TO_EXCEL = defineAction('DOC_EXPORT_TNMT_LAND_DATA_TO_EXCEL',  [LOADING, FAILURE, SUCCESS], 'thongkes');
...
export const DOC_exportArchiveBookToEXCEL    = createAction(DOC_EXPORT_ARCHIVE_BOOK_TO_EXCEL.ACTION);
export const DOC_exportTNMTLandDataToEXCEL   = createAction(DOC_EXPORT_TNMT_LAND_DATA_TO_EXCEL.ACTION);
